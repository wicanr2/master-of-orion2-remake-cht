...
OUT = os.environ.get("MOO2_RE_OUT", "/out/random-event-stasis.json")
...
ROOTS = {
    ...
    "raw_Event_Target_Colony_Star": 0x23BEC,
    ...
    "raw_Colony_Recalculator": 0xE2A70,
}
...
def main():
    ...
    report = {
        ...
        "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                 "script": "tools/ida/audit_random_event_stasis.py"},
