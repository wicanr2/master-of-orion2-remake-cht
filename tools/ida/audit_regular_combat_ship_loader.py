...
ROOTS = [0x4954A, 0x49A41, 0x4D10E]
NAME_PATTERN = re.compile(r"load.*combat.*ship|combat.*ship.*load", re.I)
...
def main():
    ...
    payload = {
        ...
        "roots": [function_record(ea) for ea in ROOTS],
...
try:
    ...
    out = os.environ.get("MOO2_IDA_OUTPUT", "/tmp/regular-combat-ship-loader.json")
