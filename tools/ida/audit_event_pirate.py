"""唯讀匯出事件 14 海盜活動的建立、逐回合消費與衝突判定資料流。"""
...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-pirate.json")
...
ROOTS = {
    ...
    "raw_Event14_Target_Picker": 0x23BEC,
    "raw_Event14_Target_Exclusion": 0x242FC,
    "raw_Event14_Initial_Strength": 0x2448F,
    "raw_Stationed_Fleet_Strength": 0x23B28,
}
...
def main():
    ...
    report = {
        ...
        "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                 "script": "tools/ida/audit_event_pirate.py"},
