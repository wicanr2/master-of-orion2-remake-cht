...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-plague.json")
...
ROOTS = {
    ...
    "raw_Plague_Active_On_Colony": 0x234B8,
...
def main():
    ...
    report = {"schema": "moo2.ida.re-evidence.v1", "evidence_scope": "static_only", "mutation": "none",
              "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                       "script": "tools/ida/audit_event_plague.py"},
