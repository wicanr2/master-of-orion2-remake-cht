"""非破壞性匯出事件畫面符號衝突、函式邊界、caller 與原始指令。"""
...
ROOTS = {
    "symbols_Start_Main_Event": 0x2031D,
    "func_names_Start_Main_Event": 0x203CB,
    "symbols_Drive_Event_Screen": 0x20400,
    "func_names_Drive_Event_Screen": 0x20460,
    "symbols_Draw_Event_Screen": 0x20460,
    "func_names_Draw_Event_Screen": 0x20538,
    "symbols_Event_Fade_In": 0x20538,
    "func_names_Event_Fade_In": 0x206A2,
}
