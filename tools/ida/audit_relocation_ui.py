"""非破壞性匯出 MOO2 集結點設定、合法性、全設／清除與星圖線條鏈。"""
...
ROOTS = {
    "raw_relocate_from_check": 0x74F8A,
    "raw_relocate_to_check": 0x74FAA,
    "raw_relocate_check": 0x75035,
    "raw_star_relocation": 0x75180,
    "raw_cancel_star_relocation": 0x7522B,
    "raw_clear_all_relocations": 0x77BB1,
    "raw_set_all_relocations": 0x785EC,
    "raw_draw_relocation_links": 0x85320,
}
