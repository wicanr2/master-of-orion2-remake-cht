"""非破壞性比較建造佇列衝突符號位址，匯出函式邊界、caller 與原始指令。"""
...
ROOTS = {
    "symbols_Add_Buildings_Fields": 0xB08CA,
    "func_names_Add_Buildings_Fields": 0xB094C,
    "symbols_Add_Build_Queue_Fields": 0xB325A,
    "symbols_Draw_Build_Queue_Popup": 0xB3CF7,
    "func_names_Draw_Build_Queue_Popup": 0xB3E75,
    "symbols_Build_Queue_Popup": 0xB4041,
}
