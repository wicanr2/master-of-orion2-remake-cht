"""唯讀匯出事件 27（Warp Funnel）的選艦、record、生命週期與航行消費端。"""
...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-warp-funnel.json")
...
EVENT27_FIELDS = range(0x19AC97, 0x19ACA0)
...
def main():
    ...
    report = {
        ...
        "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                 "script": "tools/ida/audit_event_warp_funnel.py"},
        ...
        "event27_record": {"slot": 27, "stride": 9, "base": "0x19ABA4",
                           "range": "0x19AC97..0x19AC9F", "direct_refs": direct_refs,
