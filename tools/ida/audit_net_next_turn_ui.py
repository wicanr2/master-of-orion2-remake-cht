"""非破壞性匯出 MOO2 Net_Next_Turn 畫面、欄位、繪製、配色與聊天輸入函式。"""
...
ROOTS = {
    ...
    "raw_draw_net_next_turn_screen": 0xF1075,
    "raw_get_net_next_turn_player_colors": 0xF31BB,
    "raw_chat_box_input_loop": 0xF55A4,
}
