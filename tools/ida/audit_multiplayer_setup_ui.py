"""非破壞性匯出 MOO2 多人主設定畫面的 loader、widget、outer 與模式 writer。"""
...
ROOTS = {
    "raw_multiplayer_loader": 0xF42CA,
    "raw_multiplayer_widgets": 0xF009A,
    "raw_multiplayer_screen": 0xF4D99,
    "raw_set_multiplayer_game_type": 0xF5691,
}
