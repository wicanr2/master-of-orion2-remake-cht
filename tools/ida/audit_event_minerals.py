...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-minerals.json")
...
ROOTS = {
    ...
    "raw_Mineral_Depletion_Chooser": 0x2325E,
    "raw_Mineral_Discovery_Chooser": 0x232BB,
    "raw_Random_Player_Colony": 0x23D44,
    "raw_Random_Player_Colony_Extra_Flag_Zero": 0x23DA0,
}
...
def main():
    ...
    report = {"schema": "moo2.ida.re-evidence.v1", "evidence_scope": "static_only", "mutation": "none",
              "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                       "script": "tools/ida/audit_event_minerals.py"},
