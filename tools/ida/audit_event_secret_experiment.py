...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-secret-experiment.json")
...
ROOTS = {
    ...
    "raw_Research_Field_Completion": 0xE4410,
}
...
def main():
    ...
    report = {"schema": "moo2.ida.re-evidence.v1", "evidence_scope": "static_only", "mutation": "none",
              "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                       "script": "tools/ida/audit_event_secret_experiment.py"},
