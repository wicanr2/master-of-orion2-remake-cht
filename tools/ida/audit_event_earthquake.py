"""唯讀匯出事件 7 地震的目標、傷亡、建築破壞與殖民地回寫資料流。"""
...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-earthquake.json")
...
ROOTS = {
    ...
    "raw_Earthquake_Resolver": 0x238A8,
    "raw_Event_Colony_Selector_With_Extra_Flag": 0x23DA0,
...
def main():
    ...
    report = {
        ...
        "tool": {
            ...
            "script": "tools/ida/audit_event_earthquake.py",
        },
        "input": {
