"""唯讀匯出事件 4／5 的目標、record、關係回寫與新聞參數鏈。"""
...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-diplomatic-incidents.json")
...
ROOTS = {
    ...
    "raw_Relation_Eligibility_Helper": 0x1276F0,
}
...
def main():
    ...
    report = {
        ...
        "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                 "script": "tools/ida/audit_event_diplomatic_incidents.py"},
        ...
        "consumer_jump_table": jump_table("jpt_20732", 36),
        "dispatcher_jump_table": jump_table("jpt_213A2", 36),
    }
