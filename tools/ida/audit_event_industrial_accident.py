...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-industrial-accident.json")
...
ROOTS = {
    ...
    "raw_Industrial_Target_Selector": 0x231B4,
    "raw_Industrial_Accident_Effect": 0x23833,
    "raw_Colony_Damage_Dispatch": 0xDD2F2,
    "raw_Industrial_Damage_Resolver": 0xDD13E,
    "raw_Strategic_Damage_Resolver": 0xDCEBD,
    "raw_Recompute_Colony": 0xE2A70,
}
...
def main():
    ...
    report = {
        ...
        "tool": {
            ...
            "script": "tools/ida/audit_event_industrial_accident.py",
        },
        "input": {
