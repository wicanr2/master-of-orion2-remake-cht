"""非破壞性匯出 MOO2 是／否確認框的建立、繪製與文字配置證據。"""
...
ROOTS = {
    "raw_confirmation_box": 0x77658,
    "raw_draw_confirm_box": 0x778E4,
    "raw_layout_confirm_text": 0x77A74,
    "raw_measure_wrapped_text_height": 0x103CAF,
}
