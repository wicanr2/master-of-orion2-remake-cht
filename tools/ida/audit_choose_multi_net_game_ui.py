"""非破壞性匯出 MOO2 區網對局選擇畫面的 outer、loader、widgets、draw 與改名函式。"""
...
ROOTS = {
    "raw_choose_multi_net_game": 0xF0C8E,
    "raw_load_choose_multi_net_game": 0xF40D3,
    "raw_add_choose_multi_net_game_fields": 0xEFF87,
    "raw_draw_choose_multi_net_game": 0xF1AF4,
