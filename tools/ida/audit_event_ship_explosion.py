...
OUT = os.environ.get("MOO2_RE_OUT", "/out/event-ship-explosion.json")
...
ROOTS = {
    ...
    "raw_Officer_On_Destroyed_Ship": 0x941C6,
    "raw_Remove_Ship_Record": 0xA163A,
}
...
def main():
    ...
    report = {"schema": "moo2.ida.re-evidence.v1", "evidence_scope": "static_only", "mutation": "none",
              "tool": {"name": "IDA Pro", "version": ida_kernwin.get_kernel_version(),
                       "script": "tools/ida/audit_event_ship_explosion.py"},
