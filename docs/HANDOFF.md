...
**基準訂正(2026-07-12):「還原度 20%」是 2026-07-04 接原版 LBX 美術前的過期快照,已被 07-05~12 多輪推進超越,勿再當現況錨點。** 現況=可玩的多帝國 4X 迴圈,且優先 1(音樂)、優先 2(忠實新遊戲流程)經使用者確認**已完成**、優先 4(gameplay 子系統)全接,殘留=校準/像素對齊(見下方各優先段)。**「完全跟原版一樣」仍是多輪工程,還原度須由使用者對原版實測重評——勿用測試綠/新增系統自評。**
