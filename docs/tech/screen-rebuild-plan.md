...
> 已用原版美術 + 量測熱區的畫面(主選單/星系/殖民地/種族選擇/自訂點數/研究抉擇/軍官…)不在此列。

> 2026-08-26 勘誤：命名／旗色不可列入上述完成群。`RACEOPT.LBX#0` 已證實是自訂種族框架，
> 現行合併頁以它當背景、用八個純色色塊，並未追回原版兩個獨立畫面與真旗幟資產；證據見
> `docs/re/name-banner-flow-audit-20260826.md`。
