...
- [x] ~~裝甲/護盾附錄的逐項核對(護盾已完成,**裝甲缺科技倍率**)~~
      ⚠ **2026-08-08 追認:裝甲科技倍率第 132 項已解**——手冊 Ship 條目逐級寫著
      +100%/+300%/+500%/+700%/10 倍(`gamedata.ArmorStructurePercent`)。
      當時斷言「手冊與 openorion2 都沒有」是錯的,只是沒讀到那幾頁。
- [x] ~~或逆向私有 gamedata 武器資料表,寫 dumper 抽精確值~~
      **不需要**:第 123/124 項已從可抽文字的 patch 1.5 PDF 拿到全表(18 把武器)。
