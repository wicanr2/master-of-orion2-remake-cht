...
- **2026-08-28 更新**：`byte_199CB0` 的 125 個直接站點／78 個 owner 已全部建立非破壞性索引，
  經濟、建造、科技、艦隊、外交、事件、間諜、地面戰與安塔蘭的直接難度分支均已分類；大型 AI
  函式的其餘非難度欄位仍由各子系統列管理。見
...
3. 新遊戲設定、科技與建築已閉合；難度全域的直接 consumer coverage 亦已閉合。這不會自動
   閉合原版 AI 的其餘非難度決策資料流。
