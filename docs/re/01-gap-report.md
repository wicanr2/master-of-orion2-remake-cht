...
## 76 項速查表(引用裡的括號就是這裡的短標)

| # | 短標 | # | 短標 | # | 短標 |
|---|---|---|---|---|---|
| 1 | 星系生成表 | 27 | 戰機中隊單位 | 53 | 聊天列幫浦 |
| 2 | 一星多行星缺口 | 28 | AI遷移非缺口 | 54 | 三個寫入端 |
| 3 | 殖民地/事件畫面 | 29 | 決定性化 | 55 | AI自己研究 |
| 4 | 地面戰解算 | 30 | 科技等級第二效果 | 56 | 領袖維護費 |
| 5 | 新遊戲設定畫面 | 31 | 開局建築清單 | 57 | 征服人口產出 |
| 6 | 殖民地畫面框架 | 32 | 飛彈速度 | 58 | 間諜三項加成 |
| 7 | 曲速前FTL限制 | 33 | 地面戰結構 | 59 | 成就科技效果 |
| 8 | 行星表面調查 | 34 | 重力種族特性 | 60 | 艦員防禦 |
| 9 | 星圖艦隊圖示 | 35 | 三張查表 | 61 | 兩個UI函式 |
| 10 | 蟲洞 | 36 | 聊天列資料 | 62 | 護盾減傷 |
| 11 | 48棟建築盤點 | 37 | 研究樹一手驗證 | 63 | 陸戰隊運力 |
...
| 23 | 多艦隊模型 | 49 | 安塔蘭艦隊+科技估值 | 75 | 編號壓縮 |
| 24 | 軌道資料層 | 50 | 軍官畫面座標 | 76 | 交叉引用加短標 |
| 25 | 人造行星 | 51 | 間諜UI |  |  |
| 26 | 確認框 | 52 | 生物武器分類 |  |  |
...
76. **交叉引用不必再開文件才看得懂**(2026-08-08)。
    ...
    **② 短標貼到同編號的另一個小節上。**
    合併之後,舊的 `第 60 項(分艦隊)` 變成 `第 23 項(分艦隊)`,而第 23 項的正名是「多艦隊模型」
    ——分艦隊只是它底下的一個小節。WORKLIST 的 49 列日誌也有同樣問題(列標題自己已經說明內容,
