...
// ---- 銀河貨幣交易所(Achievement 科技,不是建築)----
//
// 手冊(GAME_MANUAL.pdf,Galactic Economics 那一節)逐字:
//
//	"Galactic Currency Exchange (Achievement) … increases the income generated by
//	 all colonies (from all sources) by 50%."
//
// ⚠ **它被歸類錯過一次。** 原版建築表裡編號 18 有成本 250 PP、維護 3 BC,而 gap report
// 第 36 項用「維護費 0 = 一次性」這條自訂啟發式把它判成「常駐建築」。手冊直接說它是
