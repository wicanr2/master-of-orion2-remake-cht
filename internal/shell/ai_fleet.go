...
//     而 AI 從來沒有「進入」這個動作——它直接就在那裡了。這條缺口從第 39 項記到現在。
...
//
// 這條缺口從第 39 項記到現在:「⚠ 只對玩家艦隊生效,AI 無艦隊移動模型」。
// 現在 AI 會移動了,所以雷區對它生效。
//
