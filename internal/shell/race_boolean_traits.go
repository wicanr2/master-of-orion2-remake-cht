...
// ============ 第 129 項留下的那半 ============
//
// 第 129 項挖出了原版 13 族的 31 格特性表,並把**數值型**那 9 格(農業/工業/科研/金錢/
...
// 那句話在寫下的當天是對的;第 129 項之後就不對了。
//
// ============ 為什麼是每回合重算,不是開局設一次 ============
//
// 比照第 118 項的成就同步:重算是冪等的,所以順序與呼叫次數都不影響結果,
...
//     不是「忘了接」。逐項狀態見 docs/re/01-gap-report.md 第 130 項。
...
//
// 每回合結算前呼叫,冪等。與 syncAchievementColonyFields(第 118 項)同一種形狀。
