...
type sessionSnapshot struct {
	...
	OriginalCouncilDiplomacyState      int                 `json:"originalCouncilDiplomacyState,omitempty"`
	OriginalCouncilDiplomacyStateKnown bool                `json:"originalCouncilDiplomacyStateKnown,omitempty"`
...
func (s *GameSession) snapshot() sessionSnapshot {
	...
	for i, a := range s.AIPlayers {
		...
		ais[i] = aiSnapshot{Name: a.Name, RaceIndex: a.RaceIndex, LuckyEventCounter: a.LuckyEventCounter,
			...
			OriginalHumanIncidentPendingReasonRaw:    a.OriginalHumanIncidentPendingReasonRaw,
			OriginalHumanIncidentPendingMagnitudeRaw: a.OriginalHumanIncidentPendingMagnitudeRaw,
	...
	return sessionSnapshot{
		...
		OriginalCouncilDiplomacyState:      s.OriginalCouncilDiplomacyState,
		OriginalCouncilDiplomacyStateKnown: s.OriginalCouncilDiplomacyStateKnown,
...
func (snap sessionSnapshot) restore() *GameSession {
	...
	out := &GameSession{
		...
		OriginalCouncilDiplomacyState:      snap.OriginalCouncilDiplomacyState,
		OriginalCouncilDiplomacyStateKnown: snap.OriginalCouncilDiplomacyStateKnown,
