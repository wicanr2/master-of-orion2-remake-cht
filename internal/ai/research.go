...
//
// ⚠ 重要:AI 研究選題策略是【設計性重建,非原版 MOO2 行為】。本檔是一套「合理但非原版」
// 啟發式,單純讓 remake 的 AI 對手能自動推進科技樹。所有分類、門檻與排序規則都是設計選擇,
// 不代表原版數值或邏輯。
//
// ⚠ **這段話原本寫的是「MOO2 官方手冊與社群逆向都未公開 AI 選研究主題的實際演算法」——
// 那句 2026-08-08(第 113/114 項)之後不再成立**,已改寫成上面這樣。實際情況是:
//
...
// `gamedata.TechCategoryWeight`(階段 B 的一手值)。主題怎麼選仍是這裡的設計。
//
// **別再引用「未公開」那個說法當作不做的理由。**
package ai
