...
TARGET_EA = 0x2552D
RELATED_EAS = (
    0x233FA, 0x252A7, 0x252D5, 0x25AD2, 0x25BC6, 0x25DF1, 0x2670A,
    0x4DAB2, 0x4E3B5, 0x4EB06, 0x4F0DC, 0x4F694, 0x4FE25, 0x500CF, 0x5090C, 0x51078,
...
RELATIVE_OPERANDS = ("+5ECh]", "+60Eh]", "+617h]", "+627h]", "+62Fh]", "+637h]", "+63Fh]",
                     "+64Fh]", "+65Fh]", "+68Fh]", "+69Fh]", "+6D7h]", "+717h]",
                     "+6FFh]", "+71Fh]", "+727h]", "+72Fh]", "+737h]", "+7ECh]")
