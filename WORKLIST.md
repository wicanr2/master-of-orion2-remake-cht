...
- [x] 外交對談:自繪功能面板(提議和平/貿易/威脅,AI 依實力回應)接種族關係「報告」;原版 DIPLOMAT#29 確認 LBX 解碼器對此 38 幀動畫的圓頂區解碼損壞(非調色盤),改自繪
- [ ] 種子隨新遊戲(目前固定42);各系統數值逐項對齊原版手冊;戰術戰鬥艦艇移動/逐武器;DIPLOMAT LBX 解碼器修復(深層)
