...
> **目前定位：可玩 remake 預覽，不是已完成的原版忠實重製。** 2026-08-12 的 IDA Pro
...
遊戲使用 640×480 邏輯畫布；輸出可以整數倍放大，保留原版像素比例。以下為 2026-08-12
...
└── docs/HANDOFF.md                工作階段（session）交接與可重現的下一步
```
...
4. 想接手開發：[重製計畫](docs/REMAKE-PLAN.md) → [驗證矩陣](docs/VERIFICATION-MATRIX.md) → [交接文件](docs/HANDOFF.md)。

現況文件會隨程式碼、測試與證據更新；README 不重複列出剩餘數量、完成百分比或未經確認
的原版等價宣稱。
